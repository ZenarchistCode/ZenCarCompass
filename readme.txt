...
This mod adds the ability to "attach" a compass to the dashboard of all vanilla cars.

Now your teammates have no excuse for getting lost on their long drives to pick you up as a freshie.
...
The mod will automatically create a JSON config file in your profiles folder (profiles/Zenarchist/ZenCarCompassConfig.json) - you can add modded car offsets in there to make this work with any modded cars. The default config only works with vanilla vehicles but it's easy enough to add new vehicles - just takes some trial and error to get the compass to sit in the right place.
